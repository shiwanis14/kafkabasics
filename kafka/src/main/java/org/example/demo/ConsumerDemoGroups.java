...
public class ConsumerDemoGroups {
  ...
  /***
   *
   *Run this class in separate configuration and check in logs
   * Group is rebalanaced
   * partitions assigned to different consumers in the same group
   * gets data only of that partition when producer sends it
   */

  public static void main(String[] args) {

    final Logger logger = LoggerFactory
        .getLogger(ConsumerDemoGroups.class);//get logger for my class
